...
<script>
   function showList(){
      $.ajax({
         ...
         dataType:"json",   // 서버에서 응당하는 데이터 형식
         success: resultList,   //  서버에서 성공적으로 요청이 수행되었을때 resultList 콜백함수 호출
         erorr: function(){alert("error")}
      });
   }
   function resultList(data) {
	   ...
	   let html="<table class='table'>";                                                                                     
	    ...
	    //제이쿼리 data   //obj : json에 해당하는 객체
	    //each : data 값이 없을때까지 반복 
